...
class Player(Bot):
    ...
    def get_action(self, game_state, round_state, active):
        ...
        if RaiseAction in legal_actions and street == 4 and strength >= 0.9:
            print(f'Default: Super half confident | {strength} | {pot_odds}')
            return RaiseAction(int(max_raise / 2))

        if RaiseAction in legal_actions and street >= 5 and strength >= 0.9:
